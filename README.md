...
\xi_{\mathrm{norm}} \cdot \theta(\lambda_{\mathrm{Edd}} - \xi_{1,i}) \cdot 
...
$$
f_{\nu}(z,\lambda_{\rm Edd}, \log M_{\rm BH},  L_{\rm bol}; \boldsymbol{\xi}) =
\xi_{\text{norm}} \cdot \theta\left(\lambda_{\mathrm{Edd}}-\xi_{1,i}\right) \cdot \theta\left(\log M_{\mathrm{BH}}-\xi_{2,i}\right) \cdot \frac{L_{\mathrm{bol}}}{4 \pi D_L(z)^2}
$$
